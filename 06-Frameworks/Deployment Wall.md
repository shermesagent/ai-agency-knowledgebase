...
- **[AI is dominating the conversation at Climate Week](https://www.technologyreview.com/2026/09/24/1145048/ai-climate-week/)** (MIT Technology Review, 2026-09-24) — reports AI-driven energy investment alongside gas buildout, emissions increases, and local pollution concerns. This extends the wall from an enterprise ROI test to a public-cost test; climate-tech funding does not by itself demonstrate net emissions benefit.
- **["We'll Fix It Later": Education, AI, and the Deferral of Privacy in EdTech](https://arxiv.org/abs/2609.28137)** (Nair and Greenstadt, 2026-09-24, preprint) — interviews with 12 EdTech professionals and an audit of 48 policies document a governance-stage leak: privacy recognized, then deferred to vendors, paperwork, or districts.
...
## Practical Examples
- **Two ledgers before scaling:** along with outcome, staff review time, and recurring cost, record electricity/water and affected-neighbor concerns where relevant; for student-facing tools, require a concrete data-use and breach-escalation owner *before* the pilot. These are proposed checks, not measured impacts of a particular tool. See [[AI Use Case Evaluation Rubric]] and [[Education]].
...
## Risks / Limits
- The MIT Technology Review article reports sector-level investment and emissions trends, not a causal estimate of any single AI workload's net climate effect. The EdTech policy audit measures disclosures, not verified behavior of every platform. Do not turn either into a universal pilot-failure rate.
