...
## Core Idea
Intelligence amplification focuses on using tools to expand human cognition: memory, search, pattern recognition, simulation, creativity, and decision support.
...
## Tags
#augmentation #human-agency #research
